...
\begin{figurehere}
		\begin{center}
			\includegraphics[width=0.8\linewidth]{./Bilder/Italienischer Abend//DSC_3481-min}
		\end{center}
	\end{figurehere}
...
\begin{center}
\begin{figurehere}\includegraphics[width=.7\linewidth]{./Bilder/Italienischer Abend/DSC_3460-min}
\end{figurehere}
\end{center}
